...
public:
	...
	addr_t pathCounter0_start_addr = 0x73000000;
 	addr_t pathCounter0_size = 0x01000000;
 	addr_t pathCounter0_end_addr = pathCounter0_start_addr + pathCounter0_size - 1;
	addr_t pathCounter1_start_addr = 0x74000000;
 	addr_t pathCounter1_size = 0x01000000;
 	addr_t pathCounter1_end_addr = pathCounter1_start_addr + pathCounter1_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > pathCounter1_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	DoubleFilter path_counter0("path_counter0");
	DoubleFilter path_counter1("path_counter1");
	...
	bus.ports[12] = new PortMapping(opt.pathCounter0_start_addr, opt.pathCounter0_end_addr);
	bus.ports[13] = new PortMapping(opt.pathCounter1_start_addr, opt.pathCounter1_end_addr);
	...
	bus.isocks[12].bind(path_counter0.tsock);
	bus.isocks[13].bind(path_counter1.tsock);
