...
public:
	...
	addr_t NeuralNetwork0_start_addr = 0x73000000;
 	addr_t NeuralNetwork0_size = 0x01000000;
 	addr_t NeuralNetwork0_end_addr = NeuralNetwork0_start_addr + NeuralNetwork0_size - 1;
	addr_t NeuralNetwork1_start_addr = 0x74000000;
 	addr_t NeuralNetwork1_size = 0x01000000;
 	addr_t NeuralNetwork1_end_addr = NeuralNetwork1_start_addr + NeuralNetwork1_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > NeuralNetwork1_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	NeuralNetwork neural_network0("neural_network0");
	NeuralNetwork neural_network1("neural_network1");
	...
	bus.ports[12] = new PortMapping(opt.NeuralNetwork0_start_addr, opt.NeuralNetwork0_end_addr);
	bus.ports[13] = new PortMapping(opt.NeuralNetwork1_start_addr, opt.NeuralNetwork1_end_addr);
	...
	bus.isocks[12].bind(neural_network0.tsock);
	bus.isocks[13].bind(neural_network1.tsock);
